...
assert.match(worker, /generationImplemented: false/, "AI generation must remain disabled");
assert.match(worker, /taskCreationEnabled: false/, "task creation must remain disabled");
