...
assert.match(service, /const updateValues = \[/, "meeting digest refresh update must use an explicit 12-parameter array");
assert.match(service, /updateParamCount: updateValues\.length/, "meeting digest refresh must emit safe parameter-count diagnostics");
